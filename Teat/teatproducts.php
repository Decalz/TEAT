	  	...
	  	while($row = $result->fetch_row()) {
			...
			?>  <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
        		...
        		<div class="caption">
          		...
          		<p><a href="teataddcart.php?id=<?php echo $row[3];?>&user=buck" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Add to Cart</a></p>
        		</div>
      			</div>
    			</div>
    	<?php
